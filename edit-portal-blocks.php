...
if (isset($_POST['submit'])) {
    if (isset($_FILES['block_file']) && $_FILES['block_file']['error'] == 0) {
        ...
        $error = "Please choose a file to update.";
    }
}
?>
<!DOCTYPE html>
...
<head>
    <meta charset="utf-8" />
    <title>Edit File | MPSC Internal Portal</title>
                    ...
                    <div class="portal-blocks-panel">
                        <div class="portal-blocks-panel-body">
                            ...
                            <div class="portal-blocks-top-row">
                                <h2 class="portal-blocks-title">Edit Download File</h2>
                            </div>
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-8">
                                        <label class="pb-form-label">Current File</label>
                                        <input type="text" class="form-control" value="<?php echo !empty($row['file_name']) ? htmlspecialchars($row['file_name']) : 'No file uploaded'; ?>" readonly>
                                    </div>
                                </div>

                                <div class="row mb-4">
                                    <div class="col-md-8">
                                        <label class="pb-form-label"><span class="req">*</span>Upload New File</label>
